...
<body>
    ...
    <main class="container border mt-4">
        <div class='row'>
            ...
            <img src="img/vestiging.jpg" class='img-thumbnail'>
            <p>Wij hebben meerdere vestigingen zoals in Rotterdam, Amsterdam en Utrecht. Bij al onze vestigingen kan je online bestellen.</p>
            </div>
        </div>
